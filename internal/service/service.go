...
type ToolService interface {
	...
	UpdateTool(ctx context.Context, callerID int32, tool *domain.Tool) error
	DeleteTool(ctx context.Context, callerID, id int32) error
...
type AdminService interface {
	...
	ListMembers(ctx context.Context, adminID, orgID int32) ([]domain.User, []domain.UserOrg, error)
	SearchUsers(ctx context.Context, adminID, orgID int32, query string) ([]domain.User, []domain.UserOrg, error)
	ListJoinRequests(ctx context.Context, adminID, orgID int32) ([]domain.JoinRequest, error)
	...
	GetMemberProfile(ctx context.Context, adminID, orgID, userID int32) (*domain.User, *domain.UserOrg, error)
}
